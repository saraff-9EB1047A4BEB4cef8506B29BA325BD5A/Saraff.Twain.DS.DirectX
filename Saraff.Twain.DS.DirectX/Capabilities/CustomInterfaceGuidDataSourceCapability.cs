...
namespace Saraff.Twain.DS.DirectX.Capabilities {
    ...
    [DataSourceCapability(TwCap.CustomInterfaceGuid, TwType.Str255, SupportedOperations = TwQC.Get | TwQC.GetCurrent | TwQC.GetDefault, Get = TwOn.One)]
    internal sealed class CustomInterfaceGuidDataSourceCapability : OneDataSourceCapability<string> {

        protected override string CoreValue => this.DS.GetType().GUID.ToString("b");
    }
}
